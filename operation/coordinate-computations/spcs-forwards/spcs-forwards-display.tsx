	...
	return (
		<DataResult
			data={[
				{
					label: 'Latitude',
					value: `${FormatDMS(
						radiansToDMS(props.data.latitude),
				...
				},
				{
					label: 'Longitude',
					value: `${FormatDMS(
						radiansToDMS(Math.abs(props.data.longitude)),
						settings.latLonDecimalPlaces
					)} W`,
				},
			...
			result={[
				{
					label: 'Northing',
					value: props.result.northing.toFixed(
						settings.coordinateDecimalPlaces
					),
				},
				{
					label: 'Easting',
					value: props.result.easting.toFixed(settings.coordinateDecimalPlaces),
				},
				{
					label: 'Scale factor',
